...
if (!_isNew) then {
	...
	if (!(_model in ["SniperW1_DZ","SurvivorWO3_DZ","SurvivorWO,_DZ","SurvivorWO2_DZ","Civilian2_DZ","Civilian3_DZ","Civilian4_DZ","Civilian5_DZ","police1_DZ","police2_DZ","Hero1_DZ","Soldier1_DZ","Rocket_DZ","SurvivorW2_DZ","Survivor2_DZ","Sniper1_DZ","Camo1_DZ","BanditW1_DZ","Bandit1_DZ","SurvivorW2_DZ"])) then {
		_model = "Civilian4_DZ";
	};
